...
// GetRdKpiGrade 获取研发KPI信息
func (l *RdKpi2) GetRdKpiGrade2App() (result RdKpiResult2) {
	result.StartTime = l.StartTime
	result.EndTime = l.EndTime
	result.AccountName = l.Account
	account := dbQuery.QueryAccount(l.Db, l.Account)
...
// GetRdKpiGrade 获取研发KPI信息
func (l *RdKpi2) GetAppBackendRdKpiGrade() (result RdKpiResult2) {
	result.StartTime = l.StartTime
	result.EndTime = l.EndTime
	result.AccountName = l.Account
	account := dbQuery.QueryAccount(l.Db, l.Account)
...
func (l *RdKpi2) MakeAppRdReport(department, career, dir, boss, path string) error {
	data := l.GetRdKpiGrade2App()
...
func (l *RdKpi2) MakeAppBackendRdReport(department, career, dir, boss, path string) error {
	data := l.GetAppBackendRdKpiGrade()
